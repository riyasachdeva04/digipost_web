...
class SustainablePracticesGame:
    def __init__(self):
        ...
        self.face_cascade = cv.CascadeClassifier('/Users/riyasachdeva/Desktop/digi_post/game2/haarcascade_frontalface_default.xml')
        self.eye_cascade = cv.CascadeClassifier("/Users/riyasachdeva/Desktop/digi_post/game2/haarcascade_eye.xml")
